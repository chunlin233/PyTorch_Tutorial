...
class TestLoss(unittest.TestCase):
	...
	def test_MSELoss(self):
		...
		print('reduce=False, 输出同维度的loss:\n{}\n'.format(o_0))
		print('size_average=True，\t求平均:\t{}'.format(o_1))
		print('size_average=False，\t求和:\t{}'.format(o_2))
		print('size_none，\t求平均:\t{}'.format(o_3))

	def test_base_crossEntropyLoss(self):
		# ----------------------------------- CrossEntropy loss: base
		print("\n------------------------ test_base_crossEntropyLoss")
	...
	def test_weight_CrossEntropyLoss(self):
		# ----------------------------------- CrossEntropy loss: weight
		print("\n------------------------ test_weight_CrossEntropyLoss")
		...
		print('原始loss值为1.0986, 第2个样本是第1类，weight=0.2,所以输出为1.0986*0.2 =', 1.0986 * 0.2)
